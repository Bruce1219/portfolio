        ...
        <div class="w-full flex justify-between items-center">
            ...
            <div class="resume">
                <a
                    ...
                    target="_blank"
                    class="w-50 h-10 flex flex-col items-center overflow-hidden mr-3 bg-sky-600 hover:bg-white px-8 py-2 text-base text-white hover:text-sky-600 font-mono rounded-3xl border-2 border-transparent hover:border-sky-600 border-solid group"
                >
                    <span class="mb-2 translate-y-0 group-hover:-translate-y-8 duration-500">
                        Resume
                    </span>
                    <span class="translate-y-0 group-hover:-translate-y-8 duration-500">
                        Check it out!
                    </span>
                </a>
            </div>
